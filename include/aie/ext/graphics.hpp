...
struct image_grid : frame_grid {
  ...
  */
  ...
  void update_tile_data_image(int x, int y,
    ...
    std::experimental::mdspan<rgb, std::experimental::dynamic_extent,
                              std::experimental::dynamic_extent>
        output { reinterpret_cast<rgb*>(d.get()), image_y, image_x };
  ...
  */
  ...
  void update_tile_data_image(int x, int y,
    ...
    const std::experimental::mdspan<DataType, std::experimental::dynamic_extent,
                                    std::experimental::dynamic_extent>
        md { data, image_y, image_x };
  ...
  */
  auto& start(int &argc, char **&argv,
    ...
    t = std::thread{[&]() mutable {
      ...
      w.reset(new image_grid{nx, ny, image_x, image_y, zoom});  
