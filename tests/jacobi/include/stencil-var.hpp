...
public:
  ...
  static inline T eval(cl::sycl::accessor<T, 2, cl::sycl::access::read> a, std::function<T(int,int, cl::sycl::accessor<T, 2, cl::sycl::access::read>)> a_f, cl::sycl::accessor<T, 1, cl::sycl::access::read> b, std::function<T(int,int,int,int, cl::sycl::accessor<T, 1, cl::sycl::access::read>)> b_f, int k, int l) {
    return c_or0_s2D::template eval<T>(a, a_f, b, b_f, k, l) + c_or1_s2D::template eval<T>(a, a_f, b, b_f, k, l);
  }
  template<typename T>
  static inline T eval_local(T *a, cl::sycl::accessor<T, 1, cl::sycl::access::read> b, std::function<T(int,int,int,int, cl::sycl::accessor<T, 1, cl::sycl::access::read>)> b_f, int k, int l, int k_local, int l_local, int ldc) {
    return c_or0_s2D::template eval_local<T>(a, b, b_f, k, l, k_local, l_local, ldc) + c_or1_s2D::template eval_local<T>(a, b, b_f, k, l, k_local, l_local, ldc);
  }
};
...
public:
  ...
  template<typename T>
  static inline T eval(cl::sycl::accessor<T, 2, cl::sycl::access::read> a, std::function<T(int,int, cl::sycl::accessor<T, 2, cl::sycl::access::read>)> a_f, cl::sycl::accessor<T, 1, cl::sycl::access::read> b, std::function<T(int,int,int,int, cl::sycl::accessor<T, 1, cl::sycl::access::read>)> b_f, int k, int l) {
    return c_or0_s2D::template eval<T>(a, a_f, b, b_f, k, l);
  }
  template<typename T>
  static inline T eval_local(T *a, cl::sycl::accessor<T, 1, cl::sycl::access::read> b, std::function<T(int,int,int,int, cl::sycl::accessor<T, 1, cl::sycl::access::read>)> b_f, int k, int l, int k_local, int l_local, int ldc) {
    return c_or0_s2D::template eval_local<T>(a, b, b_f, k, l, k_local, l_local, ldc);
  }
};
...
public:
  ...
  template<typename T>
  static inline T eval(cl::sycl::accessor<T, 2, cl::sycl::access::read> a, std::function<T(int,int, cl::sycl::accessor<T, 2, cl::sycl::access::read>)> a_f, cl::sycl::accessor<T, 1, cl::sycl::access::read> b, std::function<T(int,int,int,int, cl::sycl::accessor<T, 1, cl::sycl::access::read>)> b_f, int k, int l) {
    return b_f(k,l,i,j,b) * a_f(k+i,l+j,a); // template operator ? it would be cool
  }
  template<typename T>
  static inline T eval_local(T *a, cl::sycl::accessor<T, 1, cl::sycl::access::read> b, std::function<T(int,int,int,int, cl::sycl::accessor<T, 1, cl::sycl::access::read>)> b_f, int k, int l, int k_local, int l_local, int ldc) {
...
public:
  ...
  static inline void eval(cl::sycl::id<2> id, cl::sycl::accessor<T, 2, cl::sycl::access::write> *out, cl::sycl::accessor<T, 2, cl::sycl::access::read> *in, cl::sycl::accessor<T, 1, cl::sycl::access::read> *coef) {
    int i = id.get(0) + of0;
    int j = id.get(1) + of1;
    f(i, j, *out) = st::template eval<T>(*in, a_f, *coef, b_f, i, j);
  }
  ...
  static inline void eval_local(cl::sycl::nd_item<2> it, cl::sycl::accessor<T, 2, cl::sycl::access::write> *out, T *local_tab, cl::sycl::accessor<T, 1, cl::sycl::access::read> *coef, int glob_max0, int glob_max1) {
    ...
    f(i, j, *out) = st::template eval_local<T>(local_tab, *coef, b_f, i, j, i_local, j_local, local_dim1);
  }
