...
public:
  ...
  static const int max_ind1 = std::max(c_or0_s2D::max_ind1,
                                       c_or1_s2D::max_ind1);
  template<typename T, T (*a_f) (int,int, cl::sycl::accessor<T, 2, cl::sycl::access::mode::read>), T (*b_f) (int,int,int,int, cl::sycl::accessor<T, 1, cl::sycl::access::mode::read>)>
  ...
  template<typename T, int ldc, T (*b_f) (int,int,int,int, cl::sycl::accessor<T, 1, cl::sycl::access::mode::read>)>
...
template <typename T, cl::sycl::buffer<T,2> *_aB, cl::sycl::buffer<T,1> *_bB, T (*_a_f) (int,int, cl::sycl::accessor<T, 2, cl::sycl::access::mode::read>), T (*_b_f) (int,int,int,int, cl::sycl::accessor<T, 1, cl::sycl::access::mode::read>)>
class input_var2D {};

template <typename T, class st, cl::sycl::buffer<T,2> *_aB, cl::sycl::buffer<T,1> *_bB, T (*_a_f) (int,int, cl::sycl::accessor<T, 2, cl::sycl::access::mode::read>), T (*_b_f) (int,int,int,int, cl::sycl::accessor<T, 1, cl::sycl::access::mode::read>)>
...
public:
  ...
  operation_var2D() {
    ...
    nd_range = {cl::sycl::range<2> {(size_t)r0, (size_t)r1},
                cl::sycl::range<2> {(size_t)li2D.nbi_wg0, (size_t)li2D.nbi_wg1},
                offset};
